<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="Burgerklubben.Order" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <h1 class="orderheadline">Bestilling!</h1>
            ...
            <div class="container-order">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-9 col-xs-12">
                        <div class="orders">
                            <h2>Vores ordresystem er nede!</h2>

                            <h3>Grib knoglen og ring - vores ninjaer står på spring! 
                        <br />
                                Tlf. 12 34 56 78</h3>
