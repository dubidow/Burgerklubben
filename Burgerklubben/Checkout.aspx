<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="Burgerklubben.Checkout" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    <%--<a class="nav-link active" aria-current="page" href="Frontpage.aspx">Home</a>--%>
        ...
        <div class="content">
            ...
            <h1 class="checkoutheadline">Her er din kurv!</h1>
